export const MAIN_CONFIG = {
  ...
  messages: {
    error: "Произошла ошибка при загрузке данных о типах услуг.",
    empty:
      "В данный момент нет информации о типах услуг. Попробуйте обновить страницу или обратитесь к администратору.",
